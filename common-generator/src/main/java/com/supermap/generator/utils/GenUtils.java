...
package com.supermap.generator.utils;

import cn.hutool.core.io.IoUtil;
import cn.hutool.core.util.StrUtil;
import com.supermap.generator.entity.ColumnEntity;
import com.supermap.generator.entity.TableEntity;
...
//        templates.add("template/Excel.java.vm");
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("SaveDTO.java.vm")) {
            return packagePath + "dto" + File.separator + className + "SaveDTO.java";
        }
